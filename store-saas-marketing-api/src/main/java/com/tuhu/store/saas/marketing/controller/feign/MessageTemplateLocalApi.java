...
public class MessageTemplateLocalApi {
    ...
    public BizBaseResponse getSMSTemplateIdByCodeAndStoreId(String templateCode,Long storeId) {
        return new BizBaseResponse(iMessageTemplateLocalService.getSMSTemplateIdByCodeAndStoreId(templateCode,storeId));
    }
}
