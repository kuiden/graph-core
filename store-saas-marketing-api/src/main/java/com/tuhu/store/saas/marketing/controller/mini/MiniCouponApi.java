...
//    }
    ...
    public BizBaseResponse getCustomerCouponDetail(@PathVariable Long couponId){
        CustomerCouponDetailResponse detail = iCouponService.getCustomerCouponDetail(couponId);
        return new BizBaseResponse(detail);
