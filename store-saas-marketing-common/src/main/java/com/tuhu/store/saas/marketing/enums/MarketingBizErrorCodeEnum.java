...
public enum MarketingBizErrorCodeEnum implements BizEnum {
    ...
    ACTIVITY_ENCRYPTED_CODE_NOT_INPUT(4052,"ACTIVITY_ENCRYPTED_CODE_NOT_INPUT","未输入活动编号"),
    AC_ORDER_CODE_NOT_INPUT(4050,"ACTIVITY_CUSTOMER_ORDER_CODE_NOT_INPUT","未输入活动订单号"),
    AC_ORDER_NOT_EXIST(4051,"ACTIVITY_CUSTOMER_NOT_EXIST","查询不到此活动"),
    ACTIVITY_APPLY_FAILED(4052,"ACTIVITY_APPLY_FAILED","活动报名失败"),
